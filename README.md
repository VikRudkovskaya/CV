...
![ARLogo](https://github.com/VikRudkovskaya/CV/raw/master/Screens/Logo-ARVTB-v7.png)  
...
![OKEY-Logo](https://github.com/VikRudkovskaya/CV/raw/master/Screens/Logo-Okey-v4.png)  
...
![ALP](https://github.com/VikRudkovskaya/CV/raw/master/Screens/Logo-ALP-v3.png)  
...
〘Математический анализ〙 〘Алгебра и теория чисел〙 〘Геометрия и топология〙 〘Дискретный анализ〙 〘Теория игр〙 〘Теория управления〙  〘Функциональный анализ〙 〘Математическая статистика〙 〘Философия〙
 ...
 Защита диплома бакалавра:  "Разработка iOS-приложений в среде Xcode"  
[Органайзер для чеков  ⟶ YouTube ▶ [экранная запись симулятора]](https://www.youtube.com/watch?v=PI1l7TGF9Ik&t=6s "Экранная запись симулятора")  
