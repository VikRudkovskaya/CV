...
В 2017 году начала работать в аутсорсинговой компании [~200 человек] Reksoft на различных проектах. Два самых значимых: AR ВТБ  и Okey Доставка.
...
Занималась разработкой  готовых к публикации приложений-прототипов с нуля
...
Занималась разработкой новой платформы для быстрого клонирования приложения с использованием методологии White Labeling [одно приложение ≜ один target]. Провела полный рефакторинг существующих компонентов, разработка и интеграция нового дизайна, разработка новых компонентов с учетом пожеланий заказчика.  

〘Objective-C〙 〘REST〙 〘CoreData〙 〘API GoogleMaps〙 〘White Labeling Methodology〙 

Очень понятная социальная миссия - сокращение использования пластика, перенос физических карточек в цифровой мир, избавление от необходимости носить их с собой. К сожалению, проект был заморожен и очень слабо поддерживается в настоящее время.  

╳ Проект, похоже, не поддерживается. Не работает серверная часть ╳  
...
__  
Snap Art  
[Посмотреть лендинг     ⟶](https://apps.apple.com/app/id1189930338 "Этот лендинг вызывает у меня восторг!  Настоящее произведение искусства ♡")  
